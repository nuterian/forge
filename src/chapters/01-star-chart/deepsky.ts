...
import { BAYER8, TAU, vec3, type Vec3 } from '../../core/math.ts';
...
// The nebulae are stippled against the ordered screen rather than against
// white noise, so their edges break up in the same regular way the print
// pass's shadows do instead of dissolving into static.
